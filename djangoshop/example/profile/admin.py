...
class Profileadmin(admin.ModelAdmin):
    list_display = ('name','city','images','profileimage','secondimage','thirdimage','fourthimage','price','DOB','webpage','organization','skills','location','phonenumber', )

    fieldsets = (
        (None, {
            'fields': (
                'name','city', 'images','profileimage','secondimage','thirdimage','fourthimage','price', 'DOB', 'webpage', 'organization', 'skills', 'location',
                'phonenumber',
